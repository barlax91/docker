...
#ajoute les tables à la base de donnée
def _add_tables():
    return _database.Base.metadata.create_all(bind=_database.engine)

#Crée une session de base de donnée
def get_db():
...
#fonction permettant d'afficher tous les contacts
...
#fonction permettant de selectionner un contact
